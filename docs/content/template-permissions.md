...
1. Create the template YAML in `https://github.com/your-github-org/engineering-standards`
...
catalog:
  locations:
    - type: url
      target: https://github.com/your-github-org/engineering-standards/blob/main/templates/my-template/template.yaml
      rules:
        - allow: [Template]
```
